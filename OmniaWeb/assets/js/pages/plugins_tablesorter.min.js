$(function() {
    ...
    altair_tablesorter.pager_filter_example(), altair_tablesorter.align_widget_example()
}), altair_tablesorter = {
    pager_filter_example: function() {
        ...
        e(), $(".pagesize.ts_selectize").after('<div class="selectize_fix"></div>').selectize({
            ...
            //////////////////////
            //UIkit.modal.confirm('Are you sure?', function () { t.closest("tr").remove(), o.trigger("update") }, { labels: { 'Ok': 'Yes', 'Cancel': 'No' } });
            UIkit.modal.confirm('Are you sure you want to delete this operation ?', function () {
                altair_helpers.content_preloader_show();
                
                $.ajax({ 
                    type: 'POST', 
                    url: '/Operation/DeleteConfirmed/', 
            ...
            //////////////
            //UIkit.modal.confirm("Are you sure you want to delete this operation ?", function() {
            //    t.closest("tr").remove(), o.trigger("update")
            //},function() {
            //}, {
            //    labels: {
            //        Ok: "Delete"
