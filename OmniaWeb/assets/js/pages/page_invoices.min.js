            ...
            var i = function() {
                    ...
                    var o = function() {
                        var i = $("#invoice_form_template_services"),
                            ...
                            o = e.children().length ? parseInt(e.children(".uk-grid:last").attr("data-service-number")) + 1 : 1,
                            c = {
                                invoice_service_id: o
                            },
                            a = t(c);
        ...
        var i = function(i) {
            var e = i,
                ...
                c = (parseInt(e.attr("data-invoice-id")), {
                    invoice_id: {
                        invoice_number: "IBUY44582-1",
                        invoice_date: moment().format("DD.MM.YYYY"),
                        invoice_due_date: moment().add(14, "days").format("DD.MM.YYYY"), 
                        invoice_total_value: "75 150 TND", 
                        invoice_services: [{
                            service_name: "Operation_1_Service_1",
                            service_description: "Description 1", 
                            service_progress: "23 %",
                            service_price: "984 TND"
                        }, {
                            service_name: "Operation_1_Service_2",
                            service_description: "Description 2",
                            service_progress: "23 %",
                            service_price: "1230 TND"
                        }]
                    }
                }),

                a = o(c); 
            $invoice_preview.html(a), $invoice_form.html(""), $window.resize()
        };
        $(invoice_list_class).on("click", "a", function(e) {
            e.preventDefault(),
            e.stopPropagation(),
            altair_md.card_show_hide($invoice_card, void 0, i, $(this)), $(this).closest("li").siblings("li").removeClass("md-list-item-active").end().addClass("md-list-item-active"), setTimeout(function () {
                altair_uikit.reinitialize_grid_margin()
            }, 560)
